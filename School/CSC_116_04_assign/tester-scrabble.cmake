...
if(${UNIX})
   SET(LOCEXP "${LOC}/tests/unix")
else(${UNIX})
   SET(LOCEXP "${LOC}/tests/windows")
endif(${UNIX})

# Run the test
execute_process(
        COMMAND ${EXE} ../data/twl06.txt
        TIMEOUT 40
        INPUT_FILE ${LOC}/tests/test-${ID}.in
...
endif( (run_not_successful EQUAL 0 ) OR  (run_not_successful EQUAL 1 ))
